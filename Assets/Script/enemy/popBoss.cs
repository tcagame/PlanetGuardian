...
public class popBoss : MonoBehaviour {
	...
	[SerializeField] GameObject _boss_mob_sword_pop = null;
	[SerializeField] GameObject _boss_mob_shooter_pop = null;
	[SerializeField] int POP_DOWN_ENEMY_NUM = 50;
	int _down_enemy_num = 0;

	private AudioSource se_beep;
	private AudioSource BGM_game;
	private AudioSource BGM_boss;
	private GameObject player_sc;
	private plyaer plyaer_sc;
