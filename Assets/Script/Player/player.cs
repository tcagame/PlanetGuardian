...
public class player : MonoBehaviour {
	...
	[SerializeField]
	private double MIN_SPEED_RATIO = 0.35;
	[SerializeField]
	private int MAX_HP = 150;
	[SerializeField]
	private Slider HpBar = null; //HPGUI Controller
	[SerializeField]
	private Text _text = null; // debug message text
	...
	[SerializeField]
	private GameObject _recovery = null;
	[SerializeField]
	private GameObject _sound = null;
